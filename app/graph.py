...
def build_graph(checkpointer):
    ...
    g.add_conditional_edges("inventory", lambda s: "offer" if s["missing_line"] is not None else "fulfill")
    g.add_conditional_edges("offer", lambda s: "wait_customer" if s["offer_id"] else "cancel")
    g.add_conditional_edges("wait_customer", lambda s: "apply" if s["customer_decision"] == "accept" else "cancel")
